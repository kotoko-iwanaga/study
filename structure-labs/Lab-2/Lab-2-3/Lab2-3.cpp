...
//char* getMoreMemory(char* str, int size) {
//    char* tmp = NULL;
//    tmp = (char*)calloc(size, sizeof(char));
//    strcpy(tmp, str);
//    str = (char*)realloc(str, (size+shift)*sizeof(char));
//    strcpy(str, tmp);
//    return str;
//}
...
int main() {
    ...
    file = fopen("D:\\Lab2-3\\File1.txt", "w");
    if (file == NULL) {
        exit(1);
    }
    fprintf(file, str);
